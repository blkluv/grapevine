...
const styles = {
  ...
  fileUploadAreaActive: 'border-accent-aqua bg-accent-aqua/10',
  ...
  tag: 'px-2 sm:px-3 py-1 bg-accent-aqua border-4 border-black font-mono font-bold flex items-center gap-2 text-xs sm:text-sm',
  ...
  uploadIndicator: 'p-2 sm:p-4 border-4 border-black bg-accent-aqua',
